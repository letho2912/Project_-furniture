                ...
                <div class="product-text">
                    <div class="product-text-title">
                        <a href="/trang-chu" class="nav__menu-icon">
                            ...
                            Trang chủ
                        </a>/<a href="/trang-chu/san-pham" class="nav__menu-icon">
                            {{ $title }}
                        </a>
                    </div>
                    <div class="product-sort">
                        <form method="get" action="" name="productHome">
                            <select name="order_by" onchange="document.productHome.submit ()" class="form-control">
                                <option value="">----------------</option>
